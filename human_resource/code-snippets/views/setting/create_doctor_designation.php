...
<div id="ribbon">
    ...
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li>Human Resource</li><li>Setting</li><li><a href="human_resource/doctor_designation">Doctor Designation</a></li><li>Create</li>
    </ol>
    <!-- end breadcrumb -->
                ...
                <div class="jarviswidget" id="wid-id-5" data-widget-colorbutton="false"	data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-sortable="false">
                    ...
                    <div>
                        ...
                        <div class="widget-body">
                            ...
                            <?php
                            $attributes = ['id' => 'create_doctor_designation','method'=>'post'];
                            echo form_open('human_resource/doctor_designation/create', $attributes);
                            ?>

...
<div id="ribbon">
    ...
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li>Doctor</li><li><a href="doctor/schedule">Doctors</a></li><li>Schedule</li>
    </ol>
    <!-- end breadcrumb -->
                ...
                <div class="jarviswidget" id="wid-id-5" data-widget-colorbutton="false"	data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-sortable="false">
                    ...
                    <div>
                        ...
                        <div class="widget-body">
                            ...
                            echo form_open_multipart('doctor/schedule/create', $attributes);
                            ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <select class="form-control" required name="day">
                                        ...
                                        <option <?php echo set_select('day', 1, False); ?> value="1">Saturday</option>
                                        <option <?php echo set_select('day', 2, False); ?> value="2">Sunday</option>
                                        <option <?php echo set_select('day', 3, False); ?> value="3">Monday</option>
                                        <option <?php echo set_select('day', 4, False); ?> value="4">Tuesday</option>
                                        <option <?php echo set_select('day', 5, False); ?> value="5">Wednesday</option>
                                        <option <?php echo set_select('day', 6, False); ?> value="6">Thursday</option>
                                        <option <?php echo set_select('day', 7, False); ?> value="7">Friday</option>
                                    </select>
                                </div>
                            </div>

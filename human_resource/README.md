...
The Human Resource (HR) Module in the admin panel provides functionality for managing roles and permissions within the application. This module is designed to ensure that administrators have full control over user access and actions based on their roles.

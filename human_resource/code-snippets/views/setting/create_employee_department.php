...
<div id="ribbon">
    ...
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li>Human Resource</li><li>Setting</li><li><a href="human_resource/employee_department">Employee Department</a></li><li>Create</li>
    </ol>
    <!-- end breadcrumb -->
...
<div id="content">
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
            <a href="human_resource/employee_department"><button class="btn btn-md btn-success list-btn"><i class="fa fa-list"></i> Department List</button></a>
        </div>
    </div>
                ...
                <div class="jarviswidget" id="wid-id-5" data-widget-colorbutton="false"	data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-sortable="false">
                    ...
                    <div>
                        ...
                        <div class="widget-body">
                            ...
                            <?php
                            $attributes = ['id' => 'create_employee_department','method'=>'post'];
                            echo form_open('human_resource/employee_department/create', $attributes);
                            ?>

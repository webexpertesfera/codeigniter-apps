...
<div id="ribbon">
    ...
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li>Human Resource</li><li><a href="human_resource/doctor_designation">Doctor Designation</a></li><li>Update</li>
    </ol>
    <!-- end breadcrumb -->
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
            <h1 class="page-title txt-color-blueDark">
                ...
                Update Doctor Designation
            </h1>
        </div>
        <div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
            <a href="human_resource/doctor_designation"><button class="btn btn-md btn-success list-btn"><i class="fa fa-list"></i> Designation List</button></a>
        </div>
    </div>
            ...
            <article class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
                ...
                <div class="jarviswidget" id="wid-id-5" data-widget-colorbutton="false"	data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-sortable="false">
                    ...
                    <header>
                        ...
                        <h2>Update Doctor Designation</h2>
                    </header>
                    ...
                    <div>
                        ...
                        <div class="widget-body">
                            ...
                            <?php
                            $attributes = ['id' => 'doctor_designation_update','method'=>'post'];
                            echo form_open('human_resource/doctor_designation/update', $attributes);
                            ?>

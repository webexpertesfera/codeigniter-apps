...
<div id="ribbon">
    ...
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li>Human Resource</li><li><a href="human_resource/hospital_department">Hospital Department</a></li><li>Create</li>
    </ol>
    <!-- end breadcrumb -->
                ...
                <div class="jarviswidget" id="wid-id-5" data-widget-colorbutton="false"	data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-sortable="false">
                    ...
                    <div>
                        ...
                        <div class="widget-body">
                            ...
                            <?php
                            $attributes = ['id' => 'new_hospital_department','method'=>'post'];
                            echo form_open('human_resource/hospital_department/create', $attributes);
                            ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="establish_year" required>
                                            ...
                                            <?php for($i=1990;$i<=date("Y");$i++){ ?>
                                                <option value="<?php echo $i; ?>" <?php echo set_select('establish_year', $i, False); ?>><?php echo $i; ?></option>
                                           <?php  } ?>
                                        </select>
                                    </div>
                                </fieldset>

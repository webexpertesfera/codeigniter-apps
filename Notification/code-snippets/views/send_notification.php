...
<div id="ribbon">
   ...
   <span class="ribbon-button-alignment">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="notification/notification">Send Notification</a></li>
    </ol>
    <!-- end breadcrumb -->
            ...
            <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="jarviswidget jarviswidget-color-lightgray  notifyyy"  data-widget-editbutton="true">
                    ...
                    <div class="employee-list notification-list">
                        ...
                        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <a href="notification/create"><button class="btn btn-success mt-4"><i class="fa fa-user-md custom"  style="margin-right: 6px;"></i>Send Notification</button></a>
                            </article>
                        ...
                        <tbody>
                           ...
                           <td><input type="checkbox" class="single_slot" value="<?php echo $key->id; ?>"/></td>
                             ...
                             <td><?php echo date( 'jS M Y', strtotime($key->created_at));?></td>
                             <td><a href="<?php echo base_url('notification/notification/deleteMessage/'.encrypt($key->id));?>"><button class="btn btn-info"><i class="fa fa-trash-o" aria-hidden="true"></i>
                                <a href="<?php echo base_url('notification/edit/'.encrypt($key->id));?>"><button class="btn btn-info" ><i class="fa fa-pencil" aria-hidden="true"></i>
                        </button></td>
                           </tr>
                          <?php 
                              $i++;}
...
$(document).ready(function() {
    function updateCheckedRows() {
        ...
        var anyChecked = $('input[type="checkbox"].single_slot:checked').length > 0;
        $('.delete_all').prop('disabled', !anyChecked);
    }
...
$('.delete_all').on('click', function() {
    ...
    $('input[type="checkbox"]:checked').each(function() {
        selectedIds.push($(this).val()); // Ensure this is the value you expect
    });

    if (selectedIds.length > 0) {
        $.ajax({
            url: 'notification/notification/delete_selected_message',
            type: 'POST',

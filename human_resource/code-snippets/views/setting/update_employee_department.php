...
<div id="ribbon">
    ...
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li>Human Resource</li><li><a href="human_resource/employee_department">Employee Department</a></li><li>Update</li>
    </ol>
    <!-- end breadcrumb -->
                ...
                <div class="jarviswidget" id="wid-id-5" data-widget-colorbutton="false"	data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-sortable="false">
                    ...
                    <div>
                        ...
                        <div class="widget-body">
                            ...
                            echo form_open('human_resource/employee_department/update', $attributes);
                            ?>

...
<div id="ribbon">
    ...
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li>Human Resource</li><li><a href="human_resource/employee_designation">Employee Designation</a></li><li>Update</li>
    </ol>
    <!-- end breadcrumb -->
                ...
                <div class="jarviswidget" id="wid-id-5" data-widget-colorbutton="false"	data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-sortable="false">
                    ...
                    <div>
                        ...
                        <div class="widget-body">
                            ...
                            <?php
                            $attributes = ['id' => 'employee_designation_update','method'=>'post'];
                            echo form_open('human_resource/employee_designation/update', $attributes);
                            ?>
